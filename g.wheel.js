...
Raphael.fn.g.wheelchart = function (cx, cy, r, values, opts) {
    ...
    chart.covers = covers;
    if (len == 1) {
        series.push(this.circle(cx, cy, r).attr({fill: '#89b43d', stroke: opts.stroke || "#fff", "stroke-width": opts.strokewidth == null ? 1 : opts.strokewidth})); //temporary dirty hack to remove
